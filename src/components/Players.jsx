...
const Players = () => {
    ...
    const {track, seekBg, seekBar,playStatus,play,pause,time, playWithId, previous, next, seekSong} = useContext(PlayerContext)
    ...
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
        ...
        <div className='flex flex-col items-center gap-1 m-auto'>
            ...
            <div className='flex items-center gap-5'>
                ...
                <div ref={seekBg} onClick={seekSong} className='w-[60vw] max-w-[500px] bg-gray-300 rounded-full cursor-pointed'>
